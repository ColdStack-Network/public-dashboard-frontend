import {
  ...
  IAddNewNotice,
  IAuthError,
  IClearCommonErrors, ICloseGiftModal,
  ICreateAccessKey,
  IDeleteAccessKey,
  IGetAccessKeys, IGetGift,
  ISetAccessKeys,
  ISetAuth,
  ISetCommonError,
  ISetCurrentAccessKey,
  ISetEmailSettings, ISetGift,
  ISetNotifications,
...
export interface IUserState {
  ...
  userData: IUserData;
  accessKeys: any [],
  accessKeyCurrent: any,
  usd: string,
  notifications: any,
  notificationsPagination: any,
  notificationsPanel: any,
  commonErrors: string [],
  email: any;
  gift: {
    showModal: boolean;
...
export default function user(state: IUserState = initialState, action: ActionType) {
  switch (action.type) {
