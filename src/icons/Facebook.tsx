...
function SvgFacebook({ width = "auto" }) {
  return (
    <svg
      ...
      style={toStyle("enable-background:new 0 0 309.142 309.142;")}
    >
      <g>
        <path
          style={toStyle("fill:#005CB9;")}
          d="M154.571,0C69.662,0,0.83,68.831,0.83,153.741c0,38.283,13.997,73.295,37.147,100.207
        ...
        <g>
          <g>
            <path
              style={toStyle("fill:#FFFFFF;")}
              d="M131.495,240.044h36.112c0,0,0-49.849,0-90.282h26.804l3.29-36.115h-28.7v-14.44
