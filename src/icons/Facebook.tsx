...
function SvgFacebook({ width = 'auto' }) {
	return (
		<svg width={width} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
			viewBox="0 0 309.142 309.142" style={toStyle("enable-background:new 0 0 309.142 309.142;")}>
			<g>
				<path style={toStyle("fill:#005CB9;")} d="M154.571,0C69.662,0,0.83,68.831,0.83,153.741c0,38.283,13.997,73.295,37.147,100.207
		...
		c19.551,9.007,41.312,14.039,64.249,14.039c84.909,0,153.741-68.833,153.741-153.742C308.313,68.831,239.48,0,154.571,0z"/>
				<g>
					<g>
						<path style={toStyle("fill:#FFFFFF;")} d="M131.495,240.044h36.112c0,0,0-49.849,0-90.282h26.804l3.29-36.115h-28.7v-14.44
